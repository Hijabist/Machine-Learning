# -*- coding: utf-8 -*-
"""preprocessing-fs-hijabist.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1CoEo1mgHZMjFGe0u9hFWHPWtidwBwiUx
"""
...
def face_crop(source_dir, output_dir, predictor_path):
    """
...
datasets_new = './face-cropped-hijabist'
...
!zip -r cleaned-fs-hijabist.zip ./dataset-face-shape_split
...
def augment_images(train_dir, target_count):
    ...
    augmentor = ImageDataGenerator(
        brightness_range=(0.8, 1.1),    # Variasi pencahayaan
        rotation_range=10,              # Rotasi hingga 10 derajat
...
!zip -r aug-fs-hijabist1000.zip ./dataset-face-shape_split

# Definisikan path ke file zip
zip_files_to_copy = ['aug-fs-hijabist1000.zip', 'cleaned-fs-hijabist.zip']

# Inisialisasi folder Google Drive
destination_folder = './drive/MyDrive/Hijabist-Drive/Face-shape/Hijabist-datasets/'
